...
## Absence ##
Firmin (nous a rejoint plus tard)
## Shift ## 
1er shift (7 min) Louid, Auguste (pointe basse), Tiago (aile gauche), Nestor (aile droite), Maxence (pointe haute) ==> interrompu après 7 minutes car dominitation totale et j'avais déjà eu mes réponses.
